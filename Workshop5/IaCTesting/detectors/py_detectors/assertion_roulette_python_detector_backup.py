...
class AssertionRoulettePythonDetector(AntiPatternDetector ):
    ...
    def __finding_functions_with_assertion_roulette(self, parsed_file):
        fns = []
        for block in parsed_file.body:
...
#                            print(fn)
    ...
    def __find_assertion_roulette(self, parsed_file):
        fns = self.__finding_functions_with_assertion_roulette(parsed_file)
    ...
    def detect_anti_pattern(self, parsed_file, file_path):
        ...
        if (self.__find_assertion_roulette(parsed_file)):
